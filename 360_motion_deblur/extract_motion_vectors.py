...
def draw_motion_arrows(image_path: str, gyro: Dict, accel: Dict, output_path: str):
    ...
    cv2.putText(img, "Motion Blur Direction (360 Equirectangular)", (legend_x, legend_y), 
    ...
    cv2.putText(img, "Blur direction from camera rotation", (legend_x + 50, legend_y + 25), 
